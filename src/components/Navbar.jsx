...
export default function Navbar() {
  ...
  const { setshowsearch, cartCount, navigate, token, settoken, setcartItem } =
    ...
    <div className="flex items-center justify-between py-5 font-medium">
      ...
      <div className="flex items-center gap-6">
        ...
        <div className="group relative">
          ...
          {/* DropDown Menu  if token then show this section (use profile)*/}
          {token && (
      ...
      {/* Sider bar menu for small screen */}
      <div
